...
# Explode product list to get one row per transaction-product pair
...
(
    fact_transaction_products.write
    .format("delta")
    .mode("overwrite")
    .option("overwriteSchema", "true")
    .saveAsTable("workspace.retail_project.fact_transaction_products")
)
